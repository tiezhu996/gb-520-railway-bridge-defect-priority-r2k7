...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrReviewRole), errors.Is(err, service.ErrNotDecisionOwner), errors.Is(err, service.ErrBridgeRestoreRole):
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrBridgeClosed), errors.Is(err, service.ErrDefectsUnconfirmed):
